...
//
// published:false keeps a piece out of the router, the nav, the prerenderer and
// the sitemap. Note that it does NOT keep the text out of the JS bundle -- for a
// piece that must not ship at all, move it to ./drafts/ so nothing imports it.
